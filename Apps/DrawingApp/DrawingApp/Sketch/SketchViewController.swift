...
class SketchViewController: UIViewController, SketchButtonViewDelegate {

    @IBOutlet weak var sketchView: SketchView!
    
    var buttonView: SketchButtonView!
    ...
    override func viewDidLoad() {
        ...
        // pen 값 변경
        sketchView.lineWidth = CGFloat(5)//CGFloat(10)
            sketchView.lineAlpha = CGFloat(0.5)//CGFloat(1)
        
        // create ButtonView instance
        buttonView = SketchButtonView.instanceFromNib(self)
